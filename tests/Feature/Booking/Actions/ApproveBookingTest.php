...
/**
 * @deprecated Instant Booking — ApproveBooking n'existe plus dans le flow principal.
 * PENDING_APPROVAL → EN_PAIEMENT est remplacé par ReserveBooking qui crée directement EN_PAIEMENT.
 * Ces tests sont conservés pour documenter le comportement legacy et seront supprimés en Phase 2.
 */
...
beforeEach(function (): void {
    ...
    // Legacy : on force PENDING_APPROVAL pour tester l'action deprecated
